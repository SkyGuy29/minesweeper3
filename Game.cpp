...
void Game::textStringUpdate(sf::Text& text, std::string string)
{
    text.setString(string);
    text.setOrigin(text.getLocalBounds().width / 2.0,
        text.getLocalBounds().height / 2.0);
}
void Game::textStringUpdate(sf::Text& text, std::string string, int size)
{
...
void Game::resetGrid(int minefield[][30])
{
    for (int i = 0; i < 480; i++)
        minefield[i / 30][i % 30] = 0;
}
void Game::resetGrid(bool showTile[][30])
{
    for (int i = 0; i < 480; i++)
...
void Game::randGrid(int minefield[][30], int difficulty)
{
    int coords[2];
...
void Game::labelGrid(int minefield[][30], int difficulty)
{
    //mines are nines since 9 cant show up on a minesweeper grid
    switch (difficulty)
    {
...
void Game::revealTiles(int minefield[][30], bool showTile[][30], int difficulty, int i)
{
    switch (difficulty)
    {
    case 1:
...
bool Game::buttonPressed(sf::RectangleShape button, sf::RenderWindow& window)
{
...
bool Game::notOutOfBounds(int minefield[][30], int difficulty, int i, int j, int k)
{
    switch (difficulty)
    {
    case 1:
...
bool Game::gameWin(int minefield[][30], bool showTile[][30], int difficulty)
{
    switch (difficulty)
    {
    case 1:
